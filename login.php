...
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $res = mysqli_query($conn, "select userId, userName, userPassword, userType from users where userEmail='$email'");
        ...
        if ($count == 1 && $row['userPassword'] == $password) {
            ...
            $errMSG = "Incorrect Credentials, Try again" . mysqli_error($conn);
        }
    }
}
?>
